...
export const createPieChart = (element) => {
  // define data
  const dataset = [
    {label: 'Google', count: 13},
    {label: 'Facebook', count: 83},
    {label: 'Twitter', count: 46},
    {label: 'AirBnB', count: 300},
    {label: 'LinkedIn', count: 38},
    {label: 'Tesla', count: 20},
    {label: 'Microsoft', count: 33},
    {label: 'Amazon', count: 72},
    {label: 'Trillo', count: 33},
    {label: 'Twitch', count: 29},
    {label: 'Uber', count: 61},
  ];
